...
function loadStatsPage() {
  ...
  for (row_counter = 2; row_counter < table.rows.length; row_counter++) {
    home = table.rows[row_counter].cells[2].innerHTML;
    home = parseInt(home);
    opponent = table.rows[row_counter].cells[3].innerHTML;
  ...
  document.getElementById("wins").innerHTML = count_wins;
  document.getElementById("losses").innerHTML = count_losses;
}
...
function loadPlayersPage() {
  ...
  for (i = 0; i < players.length; i++) {
    ...
    dropDown += '<button onclick = "switchPlayers(' + i + ')">' + player_name + "</button>";
  }
...
function switchPlayers(playerNum) {
  ...
  avg_receiving_yards = (players[playerNum].receiving_yards / players[playerNum].games_played);
